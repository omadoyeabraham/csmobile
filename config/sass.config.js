...
module.exports = {
  ...
  includePaths: [
    ...
    /**
     * This directory was included to enable us add our custom styles to the ionic stylesheet build process.
     * This way our styles are also part of the build.css file that ionic injects into the index.html
     */
    'src/assets/styles/dist'
  ],
